...
//  DexWidget
//
//  Created by Collin Schmitt on 12/29/24.
//
...
struct Provider: TimelineProvider {
    ...
    //computed property for random pokemon we will fetch
    ...
    var body: some View {
        ...
        case .systemMedium:
            HStack{
                ...
                .layoutPriority(1) //making this vstack the highest priority
...
//takes the designs we build in the struct above and turns it into a widget
